...
我在 2014 年开始的项目里面有一个对我来说特别亲切，几乎可以说是我人生中最重要的事情之一，这并不经常发生。我将我们的 App 从 require.js 迁移到 webpack 上，为了开启代码分割。当时我还看到一个很炫酷的特性，叫“模块热更新”。该特性允许你修改项目的 css 代码而不用重新刷新页面。在 webpack 中，他允许作用于 JavaScript。
